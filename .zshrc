...
alias bc-home="cd $DCD_REPOSITORIES_PATH/bc-homepage && nvm use && clear"
alias bc-home-s="cd $DCD_REPOSITORIES_PATH/bc-homepage && nvm use && clear && code . && lg"
alias bc-client="cd $DCD_REPOSITORIES_PATH/bc-desktop-client && nvm use && clear"
alias bc-client-s="cd $DCD_REPOSITORIES_PATH/bc-desktop-client && nvm use && clear && code . && lg"
